...
# ==============================================================================
# STYLE CSS GLOBAL (BACKGROUND COKLAT DAN ELEMEN UI)
# ==============================================================================
st.markdown(
    """
    <style>
    /* BACKGROUND UTAMA MENJADI COKLAT MUDA/CREAM */
    .stApp { 
    ...
    /* Status Box Merah Putih Tetap (Agar Kontras Tetap Terjaga) */
    .status-box-red {
...
def login_page():
    ...
    .login-title {{ font-size: 55px; font-weight: 900; color: #3e2723; text-align: center; }}
    </style>
    """, unsafe_allow_html=True)

    st.markdown('<div class="login-wrapper">', unsafe_allow_html=True)
    st.markdown('<div class="title-box"><div class="login-title">ALCAF</div></div>', unsafe_allow_html=True)
    ...
    with st.form("login_form"):
        ...
        if st.form_submit_button("Login"):
            if email == "email@alcaf.com" and password == "pw2026":
...
def main_app():
    ...
    if nav_option == "Titik Lokasi":
        st.title("Sebaran Monitoring ALCAF")
        st.subheader(f"Update Real-Time: {now.strftime('%d %B %Y')} | {now.strftime('%H:%M:%S')} WIB")
        
        st.markdown("""
        Selamat datang di **ALCAF**. Halaman ini menampilkan seluruh titik instalasi sensor 
